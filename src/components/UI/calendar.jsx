...
function Calendar({ className, classNames, showOutsideDays = true, datesWithEvents, holidayDates, ...props }) {
    // Modifiers 설정
    const modifiers = {
    ...
    const modifiersClassNames = {
        hasEvent: "bg-cyan-100 text-cyan-900",
    ...
    return (<DayPicker showOutsideDays={showOutsideDays} className={cn("p-3", className)} classNames={{
            ...
            ...classNames,
        }} modifiers={modifiers} modifiersClassNames={modifiersClassNames} components={{
